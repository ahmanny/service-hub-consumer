...
export const BookingBottomSheet = React.forwardRef<BottomSheetModal, Props>(
  (
    { provider, selectedService, onConfirm, isBooking, successContent },
    ref
  ) => {
    // THEME & STYLES
    const snapPoints = useMemo(
      () => (successContent ? ["50%"] : ["85%", "95%"]),
      [successContent]
    );
    ...
    const renderBackdrop = useCallback(
      (props: any) => (
        <BottomSheetBackdrop
          ...
          disappearsOnIndex={-1}
          opacity={0.5}
          // Disable closing on backdrop press if successContent exists
          pressBehavior={successContent ? "none" : "close"}
        />
      ),
      [successContent]
    );
    ...
    return (
      <BottomSheetModal
        ...
        // ADD THESE TWO LINES:
        enablePanDownToClose={!successContent} // Disable swipe down to close
        enableContentPanningGesture={!successContent} // Disable content-based swipe
        // enableDynamicSizing
      >
        {successContent ? (
          ...
          <BottomSheetScrollView contentContainerStyle={styles.scrollBody}>
            ...
            <View style={styles.row}>
              <DateChip
                label="Today"
                isSelected={
                  selectedDate ? isSameDay(selectedDate, today) : false
                }
            ...
            <SectionTitle
              title={
                mode === "home" ? "Your Delivery Address" : "Shop Location"
              }
            />
            <View
              style={[
            ...
            <View style={styles.noteContainer}>
              ...
              <BottomSheetTextInput
                ...
                style={[
                  styles.input,
                  { borderColor: border, color: textColor },
                ]}
              ...
              <ThemedButton
                ...
                onPress={() => {
                  ...
                  onConfirm({
                    ...
                    textAddress:
                      mode === "home" ? userAddress : providerAddress,
                    note: note ?? null,
                  });
                }}
              />
